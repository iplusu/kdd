function [ TrustTPR, TrustFPR, TH ] = getTrustBasedG2( t_th )
...
%   Detailed explanation goes here
    ...
    uDegree = [DShieldGrp2; nonDShieldGrp2];
    uDegree = sort(unique(uDegree));
    
    for idx = min(uDegree):max(uDegree)
        [dshieldUnsIP, dshieldTrust1] = calcTrust2(DShieldGrp2_IP, DShieldGrp2, idx);
        [nonDshieldUnsIP, nonDshieldTrust1] = calcTrust2(nonDShieldGrp2_IP, nonDShieldGrp2, idx);
