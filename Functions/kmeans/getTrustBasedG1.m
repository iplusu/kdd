function [ TrustTPR, TrustFPR, TH ] = getTrustBasedG1( t_th )
...
%   Detailed explanation goes here
    ...
    for idx = min(uDegree):max(uDegree)
        [dshieldUnsIP, dshieldTrust1] = calcTrust2(DShieldGrp1_IP, DShieldGrp1, idx);
        [nonDshieldUnsIP, nonDshieldTrust1] = calcTrust2(nonDShieldGrp1_IP, nonDShieldGrp1, idx);
