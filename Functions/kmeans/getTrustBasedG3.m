function [ TrustTPR, TrustFPR, TH ] = getTrustBasedG3( t_th )
...
%   Detailed explanation goes here
    ...
    for idx = min(uDegree):max(uDegree)
        [dshieldUnsIP, dshieldTrust1] = calcTrust2(DShieldGrp3_IP, DShieldGrp3, idx);
        [nonDshieldUnsIP, nonDshieldTrust1] = calcTrust2(nonDShieldGrp3_IP, nonDShieldGrp3, idx);
